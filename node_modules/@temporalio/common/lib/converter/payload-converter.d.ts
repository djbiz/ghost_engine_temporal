 ...
 * @hidden
 */
export declare function toPayloadsWithContext(converter: PayloadConverter, context: SerializationContext | undefined, values: unknown[]): Payload[] | undefined;
/**
 ...
 *     reason.
 */
export declare function fromPayloadsAtIndex<T>(converter: PayloadConverter, index: number, payloads?: Payload[] | null, context?: SerializationContext): T;
/**
 * Run {@link PayloadConverter.fromPayload} on each value in the array.
 */
export declare function arrayFromPayloads(converter: PayloadConverter, payloads?: Payload[] | null, context?: SerializationContext): unknown[];
