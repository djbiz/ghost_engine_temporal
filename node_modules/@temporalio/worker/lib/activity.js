...
class Activity {
    ...
    metricMeter;
    interceptors;
    constructor(info, fn, dataConverter, serializationContext, heartbeatCallback, _client, // May be undefined in the case of MockActivityEnvironment
    ...
    run(input) {
        return activity_1.asyncLocalStorage.run(this.context, async () => {
            try {
                ...
                return { completed: { result: await (0, internal_non_workflow_1.encodeToPayload)(this.dataConverter, result, this.serializationContext) } };
            }
            catch (err) {
