...
import type { ActivityCancellationDetails, ActivityFunction, ActivitySerializationContext, LoadedDataConverter, MetricMeter, MetricTags } from '@temporalio/common';
...
export declare class Activity {
    ...
    constructor(info: Info, fn: ActivityFunction<any[], any> | undefined, dataConverter: LoadedDataConverter, serializationContext: ActivitySerializationContext, heartbeatCallback: Context['heartbeat'], _client: Client | undefined, // May be undefined in the case of MockActivityEnvironment
