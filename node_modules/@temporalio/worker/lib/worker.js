                ...
                switch (variant) {
                    case 'start': {
                        ...
                        try {
                            ...
                            let args;
                            try {
                                args = await (0, internal_non_workflow_1.decodeArrayFromPayloads)(loadedDataConverter, task.start?.input, context);
                            }
                            catch (err) {
                            ...
                            activity = new activity_1.Activity(info, fn, loadedDataConverter, context, (details) => this.activityHeartbeatSubject.next({
                                type: 'heartbeat',
                                info: info,
                                taskToken,
                                base64TaskToken,
